...
**数据库管理：**&emsp;[数据库迁移工具flyway](https://flywaydb.org/)、表结构对比工具sqllog<br>
**大数据管理套件: **&emsp;[Ambari](http://incubator.apache.org/ambari/)、[Cloudera Manger(CDH)](https://www.cloudera.com)
#### DevOps Tool
